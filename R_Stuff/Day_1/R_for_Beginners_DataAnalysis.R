...
buildings <- c()
Buildings= c("ASL","LLCS","Library","Science Buliding")
#Add "Lincoln University" to the beginning of buildings
Buildings= c("Lincoln University","ASL","LLCS","Library","Science Buliding")
#Add "Wawa" to the end of buildings
Buildings= c("Lincoln University","ASL","LLCS","Library","Science Buliding","Wawa")B
